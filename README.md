...
To successfully build, you'll need to grab the Android 12 (API 31) JAR from [here](https://github.com/anggrayudi/android-hidden-api/), and follow the instructions to install it.
